...
public class PointServiceImpl implements PointService {
    ...
    public PointResponseDTO findPointsById(Integer id) {
        PointEntity point = pointRepository.findById(id).orElseThrow(() -> new ApiException(ErrorCode.POINT_NOT_FOUND));
    ...
    public void deletePointsById(Integer id) {
        pointRepository.findById(id).orElseThrow(() -> new ApiException(ErrorCode.POINT_NOT_FOUND));
